...
class Player < ActiveRecord::Base
  ...
  attr_accessible :login, :email, :name, :password, :password_confirmation, :rate, :country, :wins, :losses, :streak, :streak_best, :max_rate, :wins34, :losses34, :latest_ip_address
